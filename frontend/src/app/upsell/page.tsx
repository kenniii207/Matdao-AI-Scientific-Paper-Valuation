      ...
      <main className="flex-grow flex items-center justify-center px-6 py-16" data-route-item>
        <div className="w-full max-w-6xl text-center" data-route-item>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch max-w-5xl mx-auto" data-route-item>
            <div className="rounded-2xl border border-white/20 bg-white/5 p-7 text-left interactive-lift">
            ...
            <div className="rounded-2xl border border-white/10 bg-[#122a44] p-7 text-left interactive-lift">
            ...
            <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-[#0e6f84] to-[#0a4e5f] p-7 text-left interactive-lift">
